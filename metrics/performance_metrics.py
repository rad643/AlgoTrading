...
def expectancy(
    positiveProfit,
    numberTrades,
    totalProfitPositiveTrades,
    negativeProfit,
    totalProfitNegativeTrades,
):
...
def payoff_ratio(
    totalProfitPositiveTrades, totalProfitNegativeTrades, positiveProfit, negativeProfit
) -> float:
    ...
    payoff_ratio = round(
        (totalProfitPositiveTrades / positiveProfit)
        / (abs(totalProfitNegativeTrades / negativeProfit)),
        2,
    )
    return payoff_ratio
