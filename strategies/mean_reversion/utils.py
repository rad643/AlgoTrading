...
def buy(day, cashValue,nextDayOpeningPrice, fixed_bps, positionSizing,flat_fee_per_share,closingPrice, verbose_run, date,average):
    """ 
    ...
    if verbose_run:
        ...
        print("\n")
    return (entryPriceMeanReversion,positionMeanReversion,cashValue,equity,entry_day,pending_action)


def sell(day,cashValue,nextDayOpeningPrice,fixed_bps, entryPriceMeanReversion,closingPrice,flat_fee_per_share,verbose_run,date,average,positionMeanReversion):
    """ 
    ...
    if verbose_run:
        ...
        print("\n")
    return (exitPriceMeanReversion,positionMeanReversion,cashValue,equity,profitMeanReversion,exit_day,pending_action)
    

def hold(cashValue,positionMeanReversion,closingPrice,verbose_run,day,date,average):
    """ 
