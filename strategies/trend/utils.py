...
def buy(day, cashValue,nextDayOpeningPrice, fixed_bps, positionSizing,flat_fee_per_share,closingPrice, verbose_run, date,average):
    ...
    if verbose_run:
        ...
        print("\n")
    return (entryPriceTrend,positionTrend,cashValue,equity,entry_day,pending_action)


def sell(day,cashValue,nextDayOpeningPrice,fixed_bps, entryPriceTrend,closingPrice,flat_fee_per_share,verbose_run,date,average,positionTrend):
    """ 
    ...
    if verbose_run:
        ...
        print("\n")
    return (exitPriceTrend,positionTrend,cashValue,equity,profitTrend,exit_day,pending_action)
