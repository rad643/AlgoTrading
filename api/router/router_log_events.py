...
async def get_log_events_run_number(backtest_run_number:int, log_events_service: LogEventsServiceDep):
...
async def delete_log_events(backtest_run_number:int, log_events_service: LogEventsServiceDep):
