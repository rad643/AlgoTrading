...
class TestMeanRevSignal(unittest.TestCase):
    ...
    def test_main_logic_behavior(self):
        ...
        self.assertEqual(
            ...
            (1.0, 0, 10.005, 11, 89.99, 99.99, "BUY"),
        )
    ...
    def test_correct_printed_text(self):
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10 | Avg: 5.500 | Mean Reversion: SELL | Position: 0 | Cash: 100 | Equity: 100\n\n\n",
        )
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10 | Execution price: 10.005 | Avg: 10.500 | Mean Reversion: BUY | Position: 1.0 | Cash: 89.99 | Equity: 99.99\n\n\n",
        )
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10 | Avg: 10.500 | Mean Reversion: BUY | Position: 2 | Cash: 100 | Equity: 120\n\n\n",
        )
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10 | Execution price: 10.995 | Avg: 10.000 | Mean Reversion: HOLD | Position: 0 | Cash: 121.98 | Equity: 121.98 | P&L: 1.990\n\n\n",
        )
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10 | Avg: 10.000 | Mean Reversion: HOLD | Position: 0 | Cash: 100 | Equity: 100\n\n\n",
        )
        ...
        self.assertEqual(
            buffer.getvalue(),
            "Day 1 | Date: 2026-05-01 | Close: 10.000000 | Avg: 5.500 | Mean Reversion: SELL | Position: 1 | Cash: 100.000 | Equity: 110.000\n\n\n",
        )
