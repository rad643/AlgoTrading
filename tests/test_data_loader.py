...
class TestDataLoaderMethods(unittest.TestCase):
    ...
    def test_normal_csv(self):
        ...
        generator=dl.read_ticker_csv("data/5_day_input.csv", 100, verbose_run=False)
    ...
    def test_empty_csv(self):
        ...
        #we need to make sure that the temp file that we created gets deleted no matter what the outcome
        try:
            #empty csv file => generator can't yield any tuples 
            generator=dl.read_ticker_csv(temp_path_created_file, 100, verbose_run=False)
